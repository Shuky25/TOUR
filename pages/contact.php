      ...
      <div class="row align-items-center">
        <div class="col-lg-6 mx-auto text-center">
          <div class="intro-wrap">
            <h1 class="mb-0">VAS PROFIL</h1>
            <p class="text-white">Na profilu mozete dodati odredjene informacije o vama, vasem prevoznom sredstvu i primati ocene od drugih korisnika naseg sajta.</p>
          </div>
        </div>
      </div>
    </div>
